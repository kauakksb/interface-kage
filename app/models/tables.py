...
class ClassTableServ:
    ...
    def createServ(self, email_cliente, nome_cliente, mod_maq, marca, valor, descricao, status):

        try:
            self.db.insertData('servicos', email_cliente, nome_cliente, mod_maq, marca, valor, descricao, status)
        except:
